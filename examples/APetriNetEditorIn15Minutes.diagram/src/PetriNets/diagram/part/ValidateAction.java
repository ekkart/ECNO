...
public class ValidateAction extends Action {
	...
	public ValidateAction(IWorkbenchPage page) {
		setText(PetriNets.diagram.part.Messages.ValidateActionMessage);
		this.page = page;
	}
	...
	public static void runValidation(View view) {
		try {
			if (PetriNets.diagram.part.PetriNetDiagramEditorUtil
	...
	public static void runValidation(DiagramEditPart diagramEditPart, View view) {
		...
		PetriNets.diagram.providers.PetriNetValidationProvider
	...
	private static void validate(DiagramEditPart diagramEditPart, View view) {
		...
		if (target != null) {
			PetriNets.diagram.providers.PetriNetMarkerNavigationProvider
	...
	private static void createMarkers(IFile target, IStatus validationStatus,
		...
		PetriNets.diagram.part.PetriNetDiagramEditorUtil.LazyElement2ViewMap element2ViewMap = new PetriNets.diagram.part.PetriNetDiagramEditorUtil.LazyElement2ViewMap(
				diagramEditPart.getDiagramView(), collectTargetElements(
						rootStatus, new HashSet<EObject>(), allStatuses));
		for (Iterator it = allStatuses.iterator(); it.hasNext();) {
			IConstraintStatus nextStatus = (IConstraintStatus) it.next();
			View view = PetriNets.diagram.part.PetriNetDiagramEditorUtil
	...
	private static void addMarker(EditPartViewer viewer, IFile target,
		...
		PetriNets.diagram.providers.PetriNetMarkerNavigationProvider.addMarker(
