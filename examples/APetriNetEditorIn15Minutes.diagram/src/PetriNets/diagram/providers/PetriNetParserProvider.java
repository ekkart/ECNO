...
public class PetriNetParserProvider extends AbstractProvider implements
	...
	private IParser getTransitionName_5001Parser() {
		if (transitionName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { PetriNets.PetriNetsPackage.eINSTANCE
					.getNode_Name() };
			PetriNets.diagram.parsers.MessageFormatParser parser = new PetriNets.diagram.parsers.MessageFormatParser(
					features);
	...
	public IParser getParser(IAdaptable hint) {
		...
		if (vid != null) {
			return getParser(PetriNets.diagram.part.PetriNetVisualIDRegistry
					.getVisualID(vid));
		}
