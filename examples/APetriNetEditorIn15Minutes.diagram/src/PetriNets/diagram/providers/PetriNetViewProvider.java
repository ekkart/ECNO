...
public class PetriNetViewProvider extends AbstractProvider implements
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PetriNets.diagram.edit.parts.PetriNetEditPart.MODEL_ID.equals(op
				.getSemanticHint())
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = PetriNets.diagram.part.PetriNetVisualIDRegistry
					.getNodeVisualID(op.getContainerView(), domainElement);
		} else {
			visualID = PetriNets.diagram.part.PetriNetVisualIDRegistry
					.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!PetriNets.diagram.providers.PetriNetElementTypes
		...
		return PetriNets.diagram.edit.parts.TransitionEditPart.VISUAL_ID == visualID
				|| PetriNets.diagram.edit.parts.PlaceEditPart.VISUAL_ID == visualID
				|| PetriNets.diagram.edit.parts.TokenEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter,
		...
		diagram.setType(PetriNets.diagram.edit.parts.PetriNetEditPart.MODEL_ID);
	...
	public Node createTransition_2001(EObject domainElement,
		...
		node.setType(PetriNets.diagram.part.PetriNetVisualIDRegistry
	...
	public Edge createArc_4001(EObject domainElement, View containerView,
		...
		edge.setType(PetriNets.diagram.part.PetriNetVisualIDRegistry
	...
	private void stampShortcut(View containerView, Node target) {
		if (!PetriNets.diagram.edit.parts.PetriNetEditPart.MODEL_ID
			...
			shortcutAnnotation
					.getDetails()
					.put("modelID", PetriNets.diagram.edit.parts.PetriNetEditPart.MODEL_ID); //$NON-NLS-1$
