 ...
 * <ul>
 *   <li>{@link PetriNets.impl.PlaceImpl#getToken <em>Token</em>}</li>
 *   <li>{@link PetriNets.impl.PlaceImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PlaceImpl extends NodeImpl implements Place {
	...
	public EList<Token> getToken() {
		if (token == null) {
			token = new EObjectContainmentEList<Token>(Token.class, this, PetriNetsPackage.PLACE__TOKEN);
		}
		return token;
	}
	...
	public void setCapacity(int newCapacity) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PetriNetsPackage.PLACE__CAPACITY, oldCapacity, capacity));
	}
