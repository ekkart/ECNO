...
public class PetriNetsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetriNetsPackage.OBJECT: {
				PetriNets.Object object = (PetriNets.Object)theEObject;
				T result = caseObject(object);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PetriNetsPackage.NODE: {
	 ...
	 * @generated
	 */
	public T caseObject(PetriNets.Object object) {
		return null;
	}
