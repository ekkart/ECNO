...
public class Arc extends AbstractPetrinetBehaviour<PetriNets.Arc> {
	
	public Arc(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (PetriNets.Arc) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
