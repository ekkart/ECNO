...
public class Token extends AbstractPetrinetBehaviour<PetriNets.Token> {
	
	public Token(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (PetriNets.Token) element, new int[]{1}, new String[]{"t0"}, type );
	}
