...
/**
 * This is the item provider adapter for a {@link emf.bankingsystem.Account} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AccountItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Account_holder_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Account_holder_feature", "_UI_Account_type"),
				 BankingsystemPackage.Literals.ACCOUNT__HOLDER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(BankingsystemPackage.Literals.ACCOUNT__CARDS);
		}
	...
	public String getText(Object object) {
		...
		return getString("_UI_Account_type") + " " + account.getUid();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(BankingsystemPackage.Literals.ACCOUNT__CARDS,
