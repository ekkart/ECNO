...
public class EnterPIN extends dk.dtu.imm.se.ecno.runtime.Event_Values  {

	final public java.lang.Integer pin;

	public EnterPIN(IEventType type, Event event) {
		super(type.getDirectSuperType(), event);
		List<IFormalParameter> formalParameters = type.getFormalParametersList();           	
	    pin = (java.lang.Integer) event.getParameter(formalParameters.get(0)).getValue();
	}
