...
public class SelectATM extends Event_Values  {

	final public emf.bankingsystem.HW atm;

	public SelectATM(IEventType type, Event event) {
		super(type.getDirectSuperType(), event);
		List<IFormalParameter> formalParameters = type.getFormalParametersList();           	
	    atm = (emf.bankingsystem.HW) event.getParameter(formalParameters.get(0)).getValue();
	}
}
