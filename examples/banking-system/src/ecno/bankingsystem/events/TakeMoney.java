...
public class TakeMoney extends Event_Values  {

	final public Collection<emf.bankingsystem.BankNote> money;

	@SuppressWarnings("unchecked")
	public TakeMoney(IEventType type, Event event) {
		super(type.getDirectSuperType(), event);
		List<IFormalParameter> formalParameters = type.getFormalParametersList();           	
	    money = Collections.unmodifiableCollection((Collection<emf.bankingsystem.BankNote>) event.getParameter(formalParameters.get(0)).getValue());
	}
}
