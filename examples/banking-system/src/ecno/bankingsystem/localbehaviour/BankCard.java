...
public class BankCard extends AbstractPetrinetBehaviour<emf.bankingsystem.BankCard> {
	
	public BankCard(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (emf.bankingsystem.BankCard) element, new int[]{}, new String[]{"t28"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		emf.bankingsystem.BankCard self = self();
		...
		case 0: {
			...
			case 0:
				switch (param) {      
				case 0: return self().getPhysical();			      
				case 1: return self();			    
                default: return null;
                }
			default: return null;
