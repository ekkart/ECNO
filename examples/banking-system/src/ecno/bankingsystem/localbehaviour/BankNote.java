...
public class BankNote extends AbstractPetrinetBehaviour<emf.bankingsystem.BankNote> {
	
	public BankNote(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (emf.bankingsystem.BankNote) element, new int[]{}, new String[]{"t49"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		emf.bankingsystem.BankNote self = self();
