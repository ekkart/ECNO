...
public class PhysicalBankCard extends AbstractPetrinetBehaviour<emf.bankingsystem.PhysicalBankCard> {
	
	public PhysicalBankCard(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (emf.bankingsystem.PhysicalBankCard) element, new int[]{}, new String[]{"t22"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		emf.bankingsystem.PhysicalBankCard self = self();
