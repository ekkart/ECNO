...
public class Action extends AbstractPetrinetBehaviour<dk.dtu.compute.se.emf.processalgebra.Action> {
	
	public Action(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.compute.se.emf.processalgebra.Action) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.compute.se.emf.processalgebra.Action self = self();
