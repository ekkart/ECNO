...
public class ActionDef extends AbstractPetrinetBehaviour<dk.dtu.compute.se.emf.processalgebra.ActionDef> {
	
	public ActionDef(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.compute.se.emf.processalgebra.ActionDef) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.compute.se.emf.processalgebra.ActionDef self = self();
