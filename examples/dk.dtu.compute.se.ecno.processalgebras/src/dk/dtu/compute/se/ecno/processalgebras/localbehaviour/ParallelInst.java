...
public class ParallelInst extends AbstractPetrinetBehaviour<dk.dtu.compute.se.emf.processalgebra.ParallelInst> {
...
private static ProcessInstance terminating(ProcessInstance self, Collection<ProcessInstance> terminating) {
	...
	public ParallelInst(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.compute.se.emf.processalgebra.ParallelInst) element, new int[]{}, new String[]{"t0"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.compute.se.emf.processalgebra.ParallelInst self = self();
