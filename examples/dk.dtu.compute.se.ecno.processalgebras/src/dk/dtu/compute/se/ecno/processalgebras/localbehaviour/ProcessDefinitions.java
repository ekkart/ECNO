...
public class ProcessDefinitions extends AbstractPetrinetBehaviour<dk.dtu.compute.se.emf.processalgebra.ProcessDefinitions> {
	
	public ProcessDefinitions(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.compute.se.emf.processalgebra.ProcessDefinitions) element, new int[]{1}, new String[]{"t0", "t1"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.compute.se.emf.processalgebra.ProcessDefinitions self = self();
...
/* DO NOTHING */
	...
	public String[] getTransitionEvents(int transition) {
			switch (transition) {
		case 0: 
			return new String[] { "action", "lock" };
		case 1: 
			return new String[] { "init", "lock" };
		default: return null;
		}  
	}
