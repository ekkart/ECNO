...
public class Car extends AbstractPetrinetBehaviour<dk.dtu.imm.se.ecno.examples.workers.Car> {
	
	public Car(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.imm.se.ecno.examples.workers.Car) element, new int[]{1, 0}, new String[]{"t2", "t1"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.imm.se.ecno.examples.workers.Car self = self();
