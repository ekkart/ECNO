...
public class Worker extends AbstractPetrinetBehaviour<dk.dtu.imm.se.ecno.examples.workers.Worker> {
	
	public Worker(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (dk.dtu.imm.se.ecno.examples.workers.Worker) element, new int[]{1, 0}, new String[]{"t1", "t2", "t3"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		dk.dtu.imm.se.ecno.examples.workers.Worker self = self();
