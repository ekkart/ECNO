 ...
 * <ul>
 *   <li>{@link dk.dtu.imm.se.ecno.examples.workers.impl.CarImpl#getName <em>Name</em>}</li>
 *   <li>{@link dk.dtu.imm.se.ecno.examples.workers.impl.CarImpl#getPassenger <em>Passenger</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CarImpl extends EObjectImpl implements Car {
	...
	public EList<Worker> getPassenger() {
		if (passenger == null) {
			passenger = new EObjectWithInverseResolvingEList<Worker>(Worker.class, this, WorkersPackage.CAR__PASSENGER, WorkersPackage.WORKER__CAR);
		}
		return passenger;
	}
