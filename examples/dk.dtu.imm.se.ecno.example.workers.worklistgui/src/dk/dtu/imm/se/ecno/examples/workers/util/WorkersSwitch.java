 ...
 * $Id$
 */
package dk.dtu.imm.se.ecno.examples.workers.util;

import dk.dtu.imm.se.ecno.examples.workers.*;
 ...
 * <!-- end-user-doc -->
 * @see dk.dtu.imm.se.ecno.examples.workers.WorkersPackage
 * @generated
 */
public class WorkersSwitch<T> extends Switch<T> {
	/**
