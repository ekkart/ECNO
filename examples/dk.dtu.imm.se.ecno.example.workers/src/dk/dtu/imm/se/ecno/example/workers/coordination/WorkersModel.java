 ...
 */
package dk.dtu.imm.se.ecno.example.workers.coordination;

import org.eclipse.emf.common.util.EList;

import dk.dtu.imm.se.emf.example.workers.WorkersPackage;
import dk.dtu.imm.se.ecno.example.workers.automata.WorkersAutomata;
...
public class WorkersModel extends EMFPackageAdapter {
	...
	protected void createModel() {
		...
		getNamespace().setUri("http://se.imm.dtu.dk/ecno/examples/workers");
	...
	public Class<? extends Event_Values> getEventValuesClass(IEventType type) {
		if (type.equals(eventtype_doJob)) {
			return dk.dtu.imm.se.ecno.example.workers.events.DoJob.class;
		} else {
			return null;
		}
	}
