 ...
 */
package dk.dtu.imm.se.ecno.example.workers.events;
...
public class DoJob extends Event_Values  {
	...
	final public dk.dtu.imm.se.emf.example.workers.Job job;
	...
	public DoJob(IEventType type, Event event) {
	    ...
	    job = (dk.dtu.imm.se.emf.example.workers.Job) event.getParameter(formalParameters.get(0)).getValue();
	}
}
