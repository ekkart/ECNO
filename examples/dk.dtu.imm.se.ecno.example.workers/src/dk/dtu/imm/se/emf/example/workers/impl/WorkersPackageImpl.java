...
import dk.dtu.imm.se.emf.example.workers.WorkersFactory;
...
public class WorkersPackageImpl extends EPackageImpl implements WorkersPackage {
	 ...
	 * @see dk.dtu.imm.se.emf.example.workers.WorkersPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		addEOperation(jobEClass, this.getJob(), "createJobs", 0, -1, IS_UNIQUE, IS_ORDERED);
