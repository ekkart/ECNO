...
/**
 * This is the item provider adapter for a {@link example.emf.vendingmachine.Panel} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Panel_control_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Panel_control_feature", "_UI_Panel_type"),
				 VendingmachinePackage.Literals.PANEL__CONTROL,
				 true,
				 false,
				 true,
				 null,
