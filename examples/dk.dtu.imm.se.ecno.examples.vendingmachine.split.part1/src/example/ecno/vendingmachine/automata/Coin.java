...
public class Coin extends AbstractPetrinetBehaviour<example.emf.vendingmachine.Coin> {
	
	public Coin(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (example.emf.vendingmachine.Coin) element, new int[]{1, 0, 0}, new String[]{"t3", "t11", "t12"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		example.emf.vendingmachine.Coin self = self();
