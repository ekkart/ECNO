 ...
 * @generated
 */
public class VendingmachineoutputSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	public VendingmachineoutputSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case VendingmachineoutputPackage.OUTPUT: {
				Output output = (Output)theEObject;
				T result = caseOutput(output);
				if (result == null) result = caseVendingMachineComponent(output);
