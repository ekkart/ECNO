...
public class CoffeeBrewer extends AbstractPetrinetBehaviour<example.emf.vendingmachinebrewers.CoffeeBrewer> {
	
	public CoffeeBrewer(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (example.emf.vendingmachinebrewers.CoffeeBrewer) element, new int[]{0, 1}, new String[]{"t19", "t20"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		example.emf.vendingmachinebrewers.CoffeeBrewer self = self();
				
		switch (transition) {
		case 0: {
			example.ecno.vendingmachine.brewer.events.Coffee c = 
			    (example.ecno.vendingmachine.brewer.events.Coffee) choice.getEventValues("coffee");
			switch (event) {
			case 0:
				switch (param) {      
				case 0: return 1;			    
