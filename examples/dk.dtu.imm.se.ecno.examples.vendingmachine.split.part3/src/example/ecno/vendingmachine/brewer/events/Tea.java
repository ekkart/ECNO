...
public class Tea extends example.ecno.vendingmachine.events.Drink  {

	final public java.lang.String name;

	public Tea(IEventType type, Event event) {
		super(type.getDirectSuperType(), event);
		List<IFormalParameter> formalParameters = type.getFormalParametersList();           	
	    name = (java.lang.String) event.getParameter(formalParameters.get(0)).getValue();
	}
