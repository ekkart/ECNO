...
public class Coffee extends AbstractPetrinetBehaviour {
 

	public Coffee(ExecutionEngine engine, ElementType type, Element self) {
		super(engine, new int[]{1, 0, 0}, new String[]{"t1", "t2", "t16", "t3"}, type, self);
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		{
			dk.dtu.imm.se.ecno.pn.example.vendingmachine.Coffee self = (dk.dtu.imm.se.ecno.pn.example.vendingmachine.Coffee) getElement();		
			switch (transition) {
			case 0: {
				switch (event) {
				case 0:
