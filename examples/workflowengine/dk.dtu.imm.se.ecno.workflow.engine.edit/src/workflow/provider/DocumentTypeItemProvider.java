...
/**
 * This is the item provider adapter for a {@link workflow.DocumentType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DocumentTypeItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.DOCUMENT_TYPE__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((DocumentType)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_DocumentType_type") :
			getString("_UI_DocumentType_type") + " " + label;
	}
