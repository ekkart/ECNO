...
/**
 * This is the item provider adapter for a {@link workflow.Place} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkflowPackage.Literals.PLACE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addInPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_in_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_in_feature", "_UI_Place_type"),
				 WorkflowPackage.Literals.PLACE__IN,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addOutPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_out_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_out_feature", "_UI_Place_type"),
				 WorkflowPackage.Literals.PLACE__OUT,
				 true,
				 false,
				 true,
				 null,
