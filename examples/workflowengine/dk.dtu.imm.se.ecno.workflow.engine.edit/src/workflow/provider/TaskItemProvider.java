	...
	protected void addAspectsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Task_aspects_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Task_aspects_feature", "_UI_Task_type"),
				 WorkflowPackage.Literals.TASK__ASPECTS,
				 true,
				 false,
				 true,
				 null,
