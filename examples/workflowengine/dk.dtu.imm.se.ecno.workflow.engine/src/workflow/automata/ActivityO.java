...
public class ActivityO extends AbstractPetrinetBehaviour<workflow.ActivityO> {
	
	public ActivityO(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.ActivityO) element, new int[]{}, new String[]{"t0"}, type );
	}
