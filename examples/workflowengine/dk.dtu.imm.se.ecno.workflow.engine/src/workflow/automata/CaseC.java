...
public class CaseC extends AbstractPetrinetBehaviour<workflow.CaseC> {
	
	public CaseC(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.CaseC) element, new int[]{}, new String[]{"t0"}, type );
	}
