...
public class CaseI extends AbstractPetrinetBehaviour<workflow.CaseI> {
	
	public CaseI(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.CaseI) element, new int[]{}, new String[]{"t0"}, type );
	}
...
/* DO NOTHING */
	...
	public String[] getTransitionEvents(int transition) {
			switch (transition) {
		case 0: 
			return new String[] { "StartActivity", "StartActivityI" };
		default: return null;
		}  
	}
