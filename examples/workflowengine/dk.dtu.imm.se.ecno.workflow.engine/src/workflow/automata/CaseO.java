...
public class CaseO extends AbstractPetrinetBehaviour<workflow.CaseO> {
	
	public CaseO(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.CaseO) element, new int[]{}, new String[]{"t0"}, type );
	}
