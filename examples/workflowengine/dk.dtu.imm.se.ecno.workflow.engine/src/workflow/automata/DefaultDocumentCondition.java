...
public class DefaultDocumentCondition extends AbstractPetrinetBehaviour<workflow.DefaultDocumentCondition> {


final coded.util.DefaultDocumentConditionUtil util = coded.util.DefaultDocumentConditionUtil.getInstance();	
	public DefaultDocumentCondition(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.DefaultDocumentCondition) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		workflow.DefaultDocumentCondition self = self();
	...
	public boolean evaluateCondition(PetriNetChoice choice) {
		...
		case 0: {
			workflow.events.StartActivityI si = 
                (workflow.events.StartActivityI) choice.getEventValues("StartActivityI");
			return util.evaluate(self,si.caseI); 
		}
		case 1: {
			workflow.events.FinishActivity f = 
                (workflow.events.FinishActivity) choice.getEventValues("FinishActivity");
			return util.evaluate(self,f.activity); 
		}
		default: return false;
		}  
	}	
