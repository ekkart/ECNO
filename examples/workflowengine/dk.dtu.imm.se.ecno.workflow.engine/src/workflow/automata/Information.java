...
public class Information extends AbstractPetrinetBehaviour<workflow.Information> {
	
	public Information(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.Information) element, new int[]{}, new String[]{"t0"}, type );
	}
	...
	public Object getParamAssignment(PetriNetChoice choice, int event, int param) {
		...
		workflow.Information self = self();
