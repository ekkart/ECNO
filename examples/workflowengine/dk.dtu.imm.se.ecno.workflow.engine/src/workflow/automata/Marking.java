...
public class Marking extends AbstractPetrinetBehaviour<workflow.Marking> {
	
	public Marking(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.Marking) element, new int[]{}, new String[]{"t0"}, type );
	}
...
/* DO NOTHING */
	...
	public String[] getTransitionEvents(int transition) {
			switch (transition) {
		case 0: 
			return new String[] { "StartActivity", "StartActivityC" };
		default: return null;
		}  
	}
