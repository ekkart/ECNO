...
public class PetriNet extends AbstractPetrinetBehaviour<workflow.PetriNet> {
	
	public PetriNet(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.PetriNet) element, new int[]{}, new String[]{"t0"}, type );
	}
...
/* DO NOTHING */
	...
	public String[] getTransitionEvents(int transition) {
			switch (transition) {
		case 0: 
			return new String[] { "StartActivityC" };
		default: return null;
		}  
	}
