...
public class Process extends AbstractPetrinetBehaviour<workflow.Process> {


final coded.util.ProcessUtil util = coded.util.ProcessUtil.getInstance(); 	
	public Process(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.Process) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
