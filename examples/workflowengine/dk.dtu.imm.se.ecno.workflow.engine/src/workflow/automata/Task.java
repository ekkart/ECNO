...
public class Task extends AbstractPetrinetBehaviour<workflow.Task> {
	
	public Task(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.Task) element, new int[]{}, new String[]{"t0"}, type );
	}
