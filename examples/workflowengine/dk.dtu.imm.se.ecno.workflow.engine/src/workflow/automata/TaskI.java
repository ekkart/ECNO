...
public class TaskI extends AbstractPetrinetBehaviour<workflow.TaskI> {
	
	public TaskI(ExecutionEngine engine, IElementType type,  EObject element) {
		super(engine, (workflow.TaskI) element, new int[]{}, new String[]{"t0", "t1"}, type );
	}
