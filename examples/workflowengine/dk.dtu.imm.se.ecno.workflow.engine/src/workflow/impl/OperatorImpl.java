 ...
 * <ul>
 *   <li>{@link workflow.impl.OperatorImpl#getOperands <em>Operands</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class OperatorImpl extends ExpressionImpl implements Operator {
	...
	public EList<Expression> getOperands() {
		if (operands == null) {
			operands = new EObjectContainmentEList<Expression>(Expression.class, this, WorkflowPackage.OPERATOR__OPERANDS);
		}
		return operands;
	}
