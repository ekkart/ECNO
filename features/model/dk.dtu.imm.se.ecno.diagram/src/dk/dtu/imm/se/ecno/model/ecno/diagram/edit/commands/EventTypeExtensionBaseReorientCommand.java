 ...
 * @generated
 */
public class EventTypeExtensionBaseReorientCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public EventTypeExtensionBaseReorientCommand(
	...
	public boolean canExecute() {
		if (false == referenceOwner instanceof EventTypeExtension) {
			return false;
		}
	...
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof EventType && newEnd instanceof EventTypeExtension)) {
			return false;
		}
		return EcnoBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEventTypeExtensionBase_4005(getNewSource(),
						getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return EcnoBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistEventTypeExtensionBase_4005(getOldSource(),
						getNewTarget());
	}
	...
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setBase(null);
		getNewSource().setBase(getOldTarget());
	...
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setBase(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
	...
	protected EventTypeExtension getOldSource() {
		return (EventTypeExtension) referenceOwner;
	}
