 ...
 * @generated
 */
public class EcnoDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public EcnoDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof EcnoDomainNavigatorItem) {
			return wrapEObjects(
					myAdapterFctoryContentProvier.getChildren(((EcnoDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new EcnoDomainNavigatorItem((EObject) objects[i],
