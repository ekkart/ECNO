...
import dk.dtu.imm.se.ecno.model.ecno.diagram.part.EcnoDiagramEditor;
 ...
 * @generated
 */
public class EcnoNavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EcnoNavigatorItem) {
					selectedElement = ((EcnoNavigatorItem) selectedElement)
							.getView();
		...
		public void run() {
			...
			try {
				page.openEditor(editorInput, EcnoDiagramEditor.ID);
