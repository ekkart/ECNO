 ...
 * @generated
 */
public class EcnoViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			visualID = EcnoVisualIDRegistry.getNodeVisualID(
					op.getContainerView(), domainElement);
		} else {
			visualID = EcnoVisualIDRegistry.getVisualID(op.getSemanticHint());
			if (elementType != null) {
				if (!EcnoElementTypes.isKnownElementType(elementType)
				...
				if (!PackageEditPart.MODEL_ID.equals(EcnoVisualIDRegistry
		...
		return EventTypeEditPart.VISUAL_ID == visualID
				|| ElementTypeEditPart.VISUAL_ID == visualID
				|| EventTypeExtensionEditPart.VISUAL_ID == visualID
				|| FormalParameterEditPart.VISUAL_ID == visualID
				|| CoordinationSetEditPart.VISUAL_ID == visualID
				|| FormalParameter2EditPart.VISUAL_ID == visualID;
	}
	...
	protected boolean provides(CreateEdgeViewOperation op) {
		...
		int visualID = EcnoVisualIDRegistry.getVisualID(elementTypeHint);
		EObject domainElement = getSemanticElement(op.getSemanticAdapter());
		if (domainElement != null
				&& visualID != EcnoVisualIDRegistry
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView,
		...
		if (semanticHint == null) {
			visualID = EcnoVisualIDRegistry.getNodeVisualID(containerView,
					domainElement);
		} else {
			visualID = EcnoVisualIDRegistry.getVisualID(semanticHint);
		}
		switch (visualID) {
		case EventTypeEditPart.VISUAL_ID:
			return createEventType_2001(domainElement, containerView, index,
					persisted, preferencesHint);
		case ElementTypeEditPart.VISUAL_ID:
			return createElementType_2002(domainElement, containerView, index,
					persisted, preferencesHint);
		case EventTypeExtensionEditPart.VISUAL_ID:
			return createEventTypeExtension_2003(domainElement, containerView,
					index, persisted, preferencesHint);
		case FormalParameterEditPart.VISUAL_ID:
			return createFormalParameter_3002(domainElement, containerView,
					index, persisted, preferencesHint);
		case CoordinationSetEditPart.VISUAL_ID:
			return createCoordinationSet_3001(domainElement, containerView,
					index, persisted, preferencesHint);
		case FormalParameter2EditPart.VISUAL_ID:
			return createFormalParameter_3003(domainElement, containerView,
					index, persisted, preferencesHint);
		}
	...
	public Edge createEdge(IAdaptable semanticAdapter, View containerView,
		...
		String elementTypeHint = ((IHintedType) elementType).getSemanticHint();
		switch (EcnoVisualIDRegistry.getVisualID(elementTypeHint)) {
		...
		case SynchronisationEditPart.VISUAL_ID:
			return createSynchronisation_4002(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		case ElementTypeSuperEditPart.VISUAL_ID:
			return createElementTypeSuper_4003(containerView, index, persisted,
					preferencesHint);
		case EventTypeSuperEditPart.VISUAL_ID:
			return createEventTypeSuper_4004(containerView, index, persisted,
					preferencesHint);
		case EventTypeExtensionBaseEditPart.VISUAL_ID:
			return createEventTypeExtensionBase_4005(containerView, index,
					persisted, preferencesHint);
		case String2EventTypeExtensionMapEditPart.VISUAL_ID:
			return createString2EventTypeExtensionMap_4006(
					getSemanticElement(semanticAdapter), containerView, index,
					persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createEventType_2001(EObject domainElement, View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EcnoVisualIDRegistry.getType(EventTypeEditPart.VISUAL_ID));
		...
		createCompartment(node,
				EcnoVisualIDRegistry
						.getType(EventTypeParametersEditPart.VISUAL_ID), true,
				false, true, true);
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createElementType_2002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(EcnoVisualIDRegistry
				.getType(ElementTypeEditPart.VISUAL_ID));
		ViewUtil.insertChildView(containerView, node, index, persisted);
		node.setElement(domainElement);
		stampShortcut(containerView, node);
		// initializeFromPreferences 
		...
		Node label5002 = createLabel(node,
				EcnoVisualIDRegistry.getType(ElementTypeNameEditPart.VISUAL_ID));
		return node;
	}
	 ...
	 * @generated
	 */
	public Node createEventTypeExtension_2003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createFormalParameter_3002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
	 ...
	 * @generated
	 */
	public Node createCoordinationSet_3001(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
	 ...
	 * @generated
	 */
	public Node createFormalParameter_3003(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Node node = NotationFactory.eINSTANCE.createNode();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createLocation());
	...
	public Edge createReference_4001(EObject domainElement, View containerView,
		...
		edge.setType(EcnoVisualIDRegistry.getType(ReferenceEditPart.VISUAL_ID));
		...
		Node label6003 = createLabel(edge,
				EcnoVisualIDRegistry
						.getType(ReferenceUpperBound2EditPart.VISUAL_ID));
	 ...
	 * @generated
	 */
	public Edge createSynchronisation_4002(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		...
		edge.setBendpoints(bendpoints);
		ViewUtil.insertChildView(containerView, edge, index, persisted);
		edge.setType(EcnoVisualIDRegistry
	 ...
	 * @generated
	 */
	public Edge createElementTypeSuper_4003(View containerView, int index,
	 ...
	 * @generated
	 */
	public Edge createEventTypeSuper_4004(View containerView, int index,
			boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createEventTypeExtensionBase_4005(View containerView,
			int index, boolean persisted, PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
		RelativeBendpoints bendpoints = NotationFactory.eINSTANCE
	 ...
	 * @generated
	 */
	public Edge createString2EventTypeExtensionMap_4006(EObject domainElement,
			View containerView, int index, boolean persisted,
			PreferencesHint preferencesHint) {
		Connector edge = NotationFactory.eINSTANCE.createConnector();
		edge.getStyles().add(NotationFactory.eINSTANCE.createFontStyle());
