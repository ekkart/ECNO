...
/**
 * This is the item provider adapter for a {@link dk.dtu.imm.se.ecno.model.ecno.ElementType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementTypeItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addParallelTriggerEventsPropertyDescriptor(object);
		}
			...
			(new ItemPropertyDescriptor
				...
				public Collection<?> getChoiceOfValues(Object object) {
					...
					if (object instanceof ElementType) {
						ElementType thisElementType = (ElementType) object;
						Collection<Object> newResult = new ArrayList<Object>();
						for (Object element: result) {
							if (element instanceof ElementType) {
								if (((ElementType) element).eContainer() != thisElementType.eContainer()) {
	...
	protected void addEClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementType_eClass_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementType_eClass_feature", "_UI_ElementType_type"),
				 EcnoPackage.Literals.ELEMENT_TYPE__ECLASS,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EcnoPackage.Literals.ELEMENT_TYPE__NAME,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addGuiPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementType_gui_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementType_gui_feature", "_UI_ElementType_type"),
				 EcnoPackage.Literals.ELEMENT_TYPE__GUI,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
	...
	protected void addSuperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementType_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementType_super_feature", "_UI_ElementType_type"),
				 EcnoPackage.Literals.ELEMENT_TYPE__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Parallel Trigger Events feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addParallelTriggerEventsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ElementType_parallelTriggerEvents_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ElementType_parallelTriggerEvents_feature", "_UI_ElementType_type"),
				 EcnoPackage.Literals.ELEMENT_TYPE__PARALLEL_TRIGGER_EVENTS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcnoPackage.Literals.ELEMENT_TYPE__COORDINATION_SETS);
			childrenFeatures.add(EcnoPackage.Literals.ELEMENT_TYPE__REFERENCES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcnoPackage.Literals.ELEMENT_TYPE__COORDINATION_SETS,
				 EcnoFactory.eINSTANCE.createCoordinationSet()));

		newChildDescriptors.add
			(createChildParameter
				(EcnoPackage.Literals.ELEMENT_TYPE__REFERENCES,
				 EcnoFactory.eINSTANCE.createReference()));
	}
