...
/**
 * This is the item provider adapter for a {@link dk.dtu.imm.se.ecno.model.ecno.EventTypeExtension} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EventTypeExtensionItemProvider
	 ...
	 * @generated
	 */
	public EventTypeExtensionItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(new ItemPropertyDescriptor
				...
				public Collection<?> getChoiceOfValues(Object object) {
					...
					if (object instanceof EventTypeExtension) {
						EventTypeExtension thisEventTypeExtension = (EventTypeExtension) object;
						Collection<Object> newResult = new ArrayList<Object>();
						for (Object element: result) {
							if (element instanceof EventTypeExtension) {
								if (((EventTypeExtension) element).eContainer() != thisEventTypeExtension.eContainer()) {
	...
	protected void addBasePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventTypeExtension_base_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventTypeExtension_base_feature", "_UI_EventTypeExtension_type"),
				 EcnoPackage.Literals.EVENT_TYPE_EXTENSION__BASE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_EventTypeExtension_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_EventTypeExtension_name_feature", "_UI_EventTypeExtension_type"),
				 EcnoPackage.Literals.EVENT_TYPE_EXTENSION__NAME,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(EcnoPackage.Literals.EVENT_TYPE_EXTENSION__PARAMETERS);
			childrenFeatures.add(EcnoPackage.Literals.EVENT_TYPE_EXTENSION__SUPER);
		}
	...
	/**
	 * This returns EventTypeExtension.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/EventTypeExtension"));
	}
	...
	public String getText(Object object) {
		String label = ((EventTypeExtension)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_EventTypeExtension_type") :
			getString("_UI_EventTypeExtension_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(EventTypeExtension.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(EcnoPackage.Literals.EVENT_TYPE_EXTENSION__PARAMETERS,
				 EcnoFactory.eINSTANCE.createFormalParameter()));

		newChildDescriptors.add
			(createChildParameter
				(EcnoPackage.Literals.EVENT_TYPE_EXTENSION__SUPER,
				 EcnoFactory.eINSTANCE.create(EcnoPackage.Literals.STRING2_EVENT_TYPE_EXTENSION_MAP)));
	}
