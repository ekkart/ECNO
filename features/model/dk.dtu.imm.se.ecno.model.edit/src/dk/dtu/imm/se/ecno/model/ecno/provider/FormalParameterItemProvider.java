...
/**
 * This is the item provider adapter for a {@link dk.dtu.imm.se.ecno.model.ecno.FormalParameter} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class FormalParameterItemProvider
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCollectivePropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormalParameter_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormalParameter_label_feature", "_UI_FormalParameter_type"),
				 EcnoPackage.Literals.FORMAL_PARAMETER__LABEL,
				 false,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Collective feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCollectivePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_FormalParameter_collective_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_FormalParameter_collective_feature", "_UI_FormalParameter_type"),
				 EcnoPackage.Literals.FORMAL_PARAMETER__COLLECTIVE,
				 true,
				 false,
				 false,
