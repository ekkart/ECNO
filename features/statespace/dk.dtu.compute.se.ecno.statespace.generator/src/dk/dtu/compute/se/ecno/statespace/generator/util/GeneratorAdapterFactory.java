 ...
 * $Id$
 */
package dk.dtu.compute.se.ecno.statespace.generator.util;
...
public class GeneratorAdapterFactory extends AdapterFactoryImpl {
	...
	protected GeneratorSwitch<Adapter> modelSwitch =
		new GeneratorSwitch<Adapter>() {
			@Override
			public Adapter caseGeneratorState(GeneratorState object) {
				return createGeneratorStateAdapter();
			}
			@Override
			public Adapter caseStateObjectEvent(StateObjectEvent object) {
				return createStateObjectEventAdapter();
			}
			@Override
			public Adapter caseGeneratorControllerState(GeneratorControllerState object) {
				return createGeneratorControllerStateAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link dk.dtu.compute.se.ecno.statespace.generator.GeneratorState <em>State</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGeneratorStateAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link dk.dtu.compute.se.ecno.statespace.generator.StateObjectEvent <em>State Object Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStateObjectEventAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link dk.dtu.compute.se.ecno.statespace.generator.GeneratorControllerState <em>Controller State</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createGeneratorControllerStateAdapter() {
		return null;
	}
