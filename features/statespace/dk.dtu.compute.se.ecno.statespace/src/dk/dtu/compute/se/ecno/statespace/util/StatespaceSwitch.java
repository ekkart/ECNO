 ...
 * @generated
 */
public class StatespaceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case StatespacePackage.STATE_OBJECT: {
				StateObject stateObject = (StateObject)theEObject;
				T result = caseStateObject(stateObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.LINK: {
				Link link = (Link)theEObject;
				T result = caseLink(link);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.EVENT: {
				Event event = (Event)theEObject;
				T result = caseEvent(event);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.PARAMETER: {
				Parameter parameter = (Parameter)theEObject;
				T result = caseParameter(parameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.OBJECT_FEATURE_VALUES: {
				ObjectFeatureValues objectFeatureValues = (ObjectFeatureValues)theEObject;
				T result = caseObjectFeatureValues(objectFeatureValues);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.VALUE: {
				Value value = (Value)theEObject;
				T result = caseValue(value);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.ELEMENT: {
				Element element = (Element)theEObject;
				T result = caseElement(element);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case StatespacePackage.STATE_SPACE_CONTROLLER_STATE: {
				StateSpaceControllerState stateSpaceControllerState = (StateSpaceControllerState)theEObject;
				T result = caseStateSpaceControllerState(stateSpaceControllerState);
				if (result == null) result = caseObjectReference(stateSpaceControllerState);
				if (result == null) result = caseControllerState(stateSpaceControllerState);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Object Feature Values</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Object Feature Values</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseObjectFeatureValues(ObjectFeatureValues object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>State Space Controller State</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>State Space Controller State</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStateSpaceControllerState(StateSpaceControllerState object) {
		return null;
	}
